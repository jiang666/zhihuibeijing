...
public class ConfirmStopLivePop {
    ...
    public ConfirmStopLivePop(Context baseActivity) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity)
                    .inflate(R.layout.layout_confirm_stop_live, null, false);
            ...
            rl_container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (ConfirmStopLivePop.this.clickCallback != null) {
                        ConfirmStopLivePop.this.clickCallback.clickClose();
                        dismissPop();
                    }
                }
            });
            ...
            tv_true.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (ConfirmStopLivePop.this.clickCallback != null) {
                        ConfirmStopLivePop.this.clickCallback.clickTrueDelect();
                        dismissPop();
                    }
                }
            });
