...
public class LiveSharePop {
    ...
    public LiveSharePop(Context baseActivity) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity)
                    .inflate(R.layout.layout_live_share, null, false);
            ...
            share_wx.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(LiveSharePop.this.clickCallback!=null){
                        LiveSharePop.this.clickCallback.shareType(0);
                        dismissPop();
                    }
                }
            });
            ...
            share_wx_zone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(LiveSharePop.this.clickCallback!=null){
                        LiveSharePop.this.clickCallback.shareType(1);
                        dismissPop();
                    }
                }
            });
            ...
            share_qq.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(LiveSharePop.this.clickCallback!=null){
                        LiveSharePop.this.clickCallback.shareType(2);
                        dismissPop();
                    }
                }
            });
            ...
            share_qq_zone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(LiveSharePop.this.clickCallback!=null){
                        LiveSharePop.this.clickCallback.shareType(3);
                        dismissPop();
                    }
                }
            });
            ...
            //动态
            LinearLayout share_tread = popView.findViewById(R.id.share_tread);
            share_tread.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(FastClickUtils.isFastClick()){
                        return;
                    ...
                    if(LiveSharePop.this.clickCallback!=null){
                        LiveSharePop.this.clickCallback.shareType(4);
                        dismissPop();
                    }
                }
            });
