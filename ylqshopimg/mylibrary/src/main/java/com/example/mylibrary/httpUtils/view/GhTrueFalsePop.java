...
public class GhTrueFalsePop {
    ...
    private boolean isleftFen;

    public void setShowTex(String showTex) {
        this.showTex = showTex;
    }

    public GhTrueFalsePop(Context baseActivity,String texTop, String texBottom,boolean isleftFen ) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity)
                    .inflate(R.layout.layout_gh_true_false, null, false);
            ...
            rl_container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (GhTrueFalsePop.this.clickCallback != null) {
                        GhTrueFalsePop.this.clickCallback.clickClose();
                        dismissPop();
                    }
                }
            });
            ...
            tv_true.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (GhTrueFalsePop.this.clickCallback != null) {
                        GhTrueFalsePop.this.clickCallback.clickTrueDelect();
                        dismissPop();
                    }
                }
            });
            ...
            if(isleftFen){
                tv_cancel.setTextColor(baseActivity.getResources().getColor(R.color.colo_FF5686));
            }else{
                tv_true.setTextColor(baseActivity.getResources().getColor(R.color.colo_FF5686));
            }
