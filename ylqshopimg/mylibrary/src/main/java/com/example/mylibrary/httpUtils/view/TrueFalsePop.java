...
public class TrueFalsePop {
    ...
    private String showTrueTex = null;

    public void setShowTex(String showTex) {
        this.showTex = showTex;
    }

    public void setTrueShowTex(String showTrueTex) {
        this.showTrueTex = showTrueTex;
    }

    public TrueFalsePop(Context baseActivity) {
    ...
    public PopupWindow showPop(ClickCallback clickCallback) {
        ...
        if (baseActivity != null) {
            popView = LayoutInflater.from(baseActivity)
                    .inflate(R.layout.layout_confirm_delect_tread, null, false);
            ...
            rl_container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (TrueFalsePop.this.clickCallback != null) {
                        TrueFalsePop.this.clickCallback.clickClose();
                        dismissPop();
                    }
                }
            });
            ...
            tv_true.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (TrueFalsePop.this.clickCallback != null) {
                        TrueFalsePop.this.clickCallback.clickTrueDelect();
                        dismissPop();
                    }
                }
            });
