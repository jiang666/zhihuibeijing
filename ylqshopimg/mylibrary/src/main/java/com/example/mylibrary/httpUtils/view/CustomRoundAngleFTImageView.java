...
public class CustomRoundAngleFTImageView extends AppCompatImageView {

    float width, height;
    int corner;

    public CustomRoundAngleFTImageView(Context context) {
        this(context, null);
        init(context, null);
    }

    public CustomRoundAngleFTImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public CustomRoundAngleFTImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        corner = DensityUtil.dip2px(context, 15);
