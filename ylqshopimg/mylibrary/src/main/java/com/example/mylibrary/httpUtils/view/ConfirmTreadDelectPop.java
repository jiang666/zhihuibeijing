...
import com.example.mylibrary.httpUtils.base.BaseWhiteStatusActivity;
...
public class ConfirmTreadDelectPop {
    ...
    public ConfirmTreadDelectPop(Context baseActivity) {
        ...
        if (baseActivity != null) {
            ...
            rl_container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (ConfirmTreadDelectPop.this.clickCallback != null) {
                        ConfirmTreadDelectPop.this.clickCallback.clickClose();
                        dismissPop();
                    }
                }
            });
            ...
            tv_true.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (ConfirmTreadDelectPop.this.clickCallback != null) {
                        ConfirmTreadDelectPop.this.clickCallback.clickTrueDelect();
                        dismissPop();
                    }
                }
            });
