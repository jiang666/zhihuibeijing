...
public class MainActivity extends AppCompatActivity  {
    ...
    public void initView(){
        ...
        RvTwo = (RecyclerView) findViewById(R.id.my_recycler_view_two);
        //使用线性布局
        ...
        RvTwo.setLayoutManager(layoutManagertwo);
        RvTwo.setHasFixedSize(true);

        //为ListView绑定适配器
        myAdapterTwo = new MyAdapterTwo(this,listItem,200);
        RvTwo.setAdapter(myAdapterTwo);
        myAdapterTwo.setOnItemClickListener(new MyAdapterTwo.OnItemClickListener() {
            @Override
            public void onItemClick(String view, int posion) {
