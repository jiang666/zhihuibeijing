...
public class BleController {
    ...
    //TODO 以下uuid根据公司硬件改变 文档中大写改小写  0000FFE0-0000-1000-8000-00805F9B34FB  ->  0000ffe0-0000-1000-8000-00805f9b34fb
    ...
    public static final String UUID_WRITE = "0000ffe7-0000-1000-8000-00805f9b34fb";
    public static final String UUID_READ = "3f3e3d3c-3b3a-3938-3736-353433323130";

    /* 图像刷新 UUID */
    public static final String UUID_SERVICE_IMAGE = "49535343-fe7d-4ae5-8fa9-9fafd205e455";
    public static final String UUID_CHARACTERISTIC_IMAGE = "49535343-8841-43f4-a8d4-ecbe34729bb3";
   ...
   /* *//**
     * 发送图片数据
     *
     * @param value    图片  EPD.getInstance().handle(bitmap);
     * @param writeCallback 发送回调
     *//*
    public void WriteBuffer(String value, OnWriteCallback writeCallback) {
        this.writeCallback = writeCallback;
        ...
        if (mBleGattCharacteristic == null) {
            mBleGattCharacteristic = getBluetoothGattCharacteristic(UUID_SERVICE_IMAGE, UUID_CHARACTERISTIC_IMAGE);
        }
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            if (null != mBleGatt && status == BluetoothGatt.GATT_SUCCESS) {
                ...
                for (int i = 0; i < services.size(); i++) {
                    ...
                    /*2022-01-17 10:06:30.952 16720-16758/com.chm.bledemo E/=====: serviceUuid = 00001800-0000-1000-8000-00805f9b34fb
                    2022-01-17 10:06:30.952 16720-16758/com.chm.bledemo E/=====: serviceUuid = 00001801-0000-1000-8000-00805f9b34fb
                    2022-01-17 10:06:30.952 16720-16758/com.chm.bledemo E/=====: serviceUuid = 0000180f-0000-1000-8000-00805f9b34fb
                    2022-01-17 10:06:30.953 16720-16758/com.chm.bledemo E/=====: serviceUuid = 0000ffe0-0000-1000-8000-00805f9b34fb
                    2022-01-17 10:06:30.953 16720-16758/com.chm.bledemo E/=====: serviceUuid = 49535343-fe7d-4ae5-8fa9-9fafd205e455
                    2022-01-17 10:06:30.953 16720-16758/com.chm.bledemo E/=====: serviceUuid = 5833ff01-9b8b-5191-6142-22a4536ef123*/
